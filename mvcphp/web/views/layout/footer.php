 <footer>
            ...
            <div class="container">
                <div class="col-lg-4 col-md-4 col-sm-4 col-12">
                    <div class="logo-footer">
                        <img src="<?= DOMAINS .'/public/image/logophong.png'?>" alt="">
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-12 footer-item footer-right">
                        <div class="footer-social">
                            ...
                            <div class="group-social">
                                <ul>
                                    <li><a href=""><img src="<?= DOMAINS .'/public/image/face.png'?>" alt=""></a></li>
                                    <li><a href=""><img src="<?= DOMAINS .'/public/image/youtube.png'?>" alt=""></a></li>
                                    <li><a href=""><img src="<?= DOMAINS .'/public/image/insta.png'?>" alt=""></a></li>
                                    <li><a href=""><img src="<?= DOMAINS .'/public/image/mail.png'?>" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <script src="<?= DOMAINS.'public/js/slick.js'?>"></script>
    <script src="<?= DOMAINS.'public/js/main.js'?>"></script>
